...
abstract class EventRepository {
  ...
  Future<Either<Failure, void>> eventAddImage({required String eventId, required String path});

  Future<Either<Failure, void>> eventReplaceImage({required String eventId, required String path});

  Future<Either<Failure, void>> eventDeleteImage({required String eventId});
}
